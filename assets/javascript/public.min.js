...
{
	// AGGIUNGI QUESTE RIGHE ALL'INIZIO DELLA FUNZIONE:
	// Forza URL relativi rimuovendo il dominio
	if(workboxObj.page) {
		workboxObj.page = workboxObj.page.replace(/https?:\/\/[^\/]+/, '');
	}
...
function getStateList(countryID,field)
{
	...
	if(countryID)
	{
		$.ajax({
			type: 'GET',
			url: '/actions.php', // URL relativo invece di baseURL+'/actions.php'
