<?php
	...
	# 4.0.5
	$mgrlang['gen_manage_media']			= "Select files to import or";
	...
	$mgrlang['gen_na']						= "N/A";
	$mgrlang['landf_f_login']				= "Show Login/Create Account";
	$mgrlang['landf_f_login_d']				= "Show the login and create account links or buttons.";
	...
	$mgrlang['webset_f_business_name_d']	= "The name of your business.";
	...
	$mgrlang['landf_f_socnet_d']			= "Display EXIF information on the media details page if it exists.";
	...
	$mgrlang['landf_f_cropgalthumb']		= "Crop Gallery Thumbnails";
	$mgrlang['landf_f_cropgalthumb_d']		= "Crop gallery thumbnails so that horizonal and verticle images display at the same size.";	
	...
	$mgrlang['galleries_f_description']		= "Short Description";
	$mgrlang['galleries_f_description_d']	= "Description of this gallery";
	...
	$mgrlang['setup_f_aka_d']				= "Allow Ktools.net access for support purposes only.";
	...
	$mgrlang['setup_f_lfo_d']				= "Override date and time settings wtih settings from the selected language file on the public website.";
	...
	$mgrlang['setup_f_autoenc_d']			= "Automatically defaults to folders being encrypted without having to check the box.";
	...
	$mgrlang['shipping_f_calc_op2']			= "Subtotal";
	...
	$mgrlang['membership_f_cpg']			= "Create Personal Galleries";
	...
	$mgrlang['promotions_f_code_d']			= "Enter a unique code for this coupon or promotion. This will be the code that the customer inputs when checking out. No spaces. Will be convered to all uppercase when saved.";
