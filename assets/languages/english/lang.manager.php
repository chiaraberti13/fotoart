<?php
	...
	$mgrlang['setup_f_uploader_op4']		= "Plupload (HTML5, Flash, Gears, Silverlight)";
	
	# 4.4.4
	$mgrlang['licenses_attach']				= "Attach License";
	$mgrlang['licenses_attach_d'] 			= "Attach a license you may of created in the content editor -> license / agreement area to this license.";
	...
	$mgrlang['subnav_storage']				= "Storage <span class='mtag_grey roundme' style='font-size: 10px; color: #FFF; font-weight: normal; padding: 2px;'>BETA</span>";
