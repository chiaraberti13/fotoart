<?php
	...
	******************************************************************/
	...
	$lang['chooseGallery']			= "Choose a gallery below to view its contents.";
	...
	$lang['newestMedia']			= "Newest Media";
	$lang['popularMedia']			= "Popular Media";	
	...
	$lang['purchaseAgreement']		= "Shipping and Payment";	
	$lang['iAgree']					= "I agree to the";	
	$lang['createAccount']			= "Create An Account";
	...
	$lang['mediaNotElidgiblePack']	= "This media is not eligible to be assigned to any packages!";
	...
	$lang['viewGalleries']		= "Browse by galleries";
	$lang['orderInfoshipnotes']	= "When shipped here the tracking code: ";
	$lang['puzzleingalleries']	= " x Puzzle";
	$lang['mediaNavCarica']	= "Upload Image";
	
	//FOOTER MOD
	$lang['footercfunction']		= "How does it work?";
	$lang['footerinfoart']	  	    = "Info Art Puzzle";
	$lang['footerinfofoto']	  	    = "Info Foto Puzzle";
	$lang['footerfaq']	  	        = "FAQ - Frequent questions";
	$lang['footermissing']	  	    = "Puzzle service";
	
	//FP
	$lang['fotopuzzleErr']			= "errore imprevisto, tornare in dietro e riprovare, grazie.";
	$lang['fotopuzzleName']			= "Photo Puzzle";	
	$lang['fotopuzzleDesc']			= "Use this image to create a high-quality puzzles!";
	$lang['TEXT_PP_TESTATA']		= "Photo Puzzle";
	$lang['TEXT_PP_SCEGLI']			= 'Choose the puzzle pieces and'; 
	$lang['TEXT_PP_TAGLIA_O']		= 'horizontal cut'; 
	$lang['TEXT_PP_TAGLIA_V']		= 'vertical';
	$lang['TEXT_PP_INVIO_IMM']		= 'sending image ...';
	$lang['TEXT_PP_CAMBIA_FOTO']	= '&larr; undo / change photo';
	$lang['TEXT_PP_CAMBIA_FORM']	= '&larr; changing size / photos';
	$lang['TEXT_PP_AVANTI']			= 'forward &rarr;';
	$lang['TEXT_PP_RIEPILOGO']		= 'summary';
	$lang['TEXT_PP_CARICA']			= 'Upload your photo';
	$lang['TEXT_PP_DESC_CARICA']	= 'valid image file of size up to ';
	$lang['TEXT_PP_MEGABYTE']		= ' Megabytes';
	$lang['TEXT_PP_SELEZIONA']		= ' Select';
	$lang['TEXT_PP_RIEPILOGO_ORDINE']	= 'Order Summary';
	$lang['TEXT_PP_CONTROLLO']		= 'Check that the text, if entered, is visible on the box. Otherwise, close this preview and click the yellow button with the pencil.';
	$lang['TEXT_PP_VERIFICA']		= 'Check box and puzzle that will be printed exactly in detail (colors, background, text, images and thumbnails';
	$lang['TEXT_PP_VERIFICA_SCATOLA']	= 'The box that you see will be printed exactly in detail (colors, background, text, images and thumbnails)';
	$lang['TEXT_PP_CONSENSO']			= '(consent required)';
	$lang['TEXT_PP_CONSENSO_CONFERMA']	= 'I checked the layout and text. I understand that the puzzle will be produced according to the image shown here, and I will not be able to make changes once executed this order. Production time 7 days';
	$lang['TEXT_PP_ACCETTA_COND']	= 'You must accept the conditions to continue with the order';
	$lang['TEXT_PP_4PUNTI']			= '<img src="assets/images/icons/pp_home_puzzle_en.jpg" border="0" width="550"/>';
	$lang['TEXT_PP_JS_INVIATE']		= 'or you can use one of the images sent previously!';
	$lang['TEXT_PP_JS_ELABORANDO']	= 'i\'m working on the case, please wait ...';
	$lang['TEXT_PP_INSERISCI_TESTO']	= 'enter text here and....press the yellow button';
	$lang['TEXT_PP_AGGIUNGI_CARR']	= 'Add to Cart';
	$lang['TEXT_PP_PEZZI']	= 'Pieces';
	$lang['TEXT_PP_FORMATO']	= 'Size';
	$lang['TEXT_PP_PREZZO']	= 'Price';
	

	$lang['TEXT_PP_SCELTA_OPZIONE'] = 'Please select an option ...';
	//$lang['TEXT_PP_OPZIONE_SCATOLA'] = 'Scatola personalizzata';
	$lang['TEXT_PUZZLES_BOX_OPTION_NAME'] = 'Scatola personalizzata';
	$lang['TEXT_PP_OPZIONE_SCATOLA_PREZZO'] = 'included in the price';
	//$lang['TEXT_PUZZLES_BOX_OPTION_NAME'] = 'Preassemblato';
	$lang['TEXT_PREASS_ATTR_NAME'] = 'Preassemblato';
	$lang['TEXT_PP_SCELTA_OPZIONE_FOOT']	= 'Note: You can not order a pre-assembled puzzles with personalized box';
	$lang['TEXT_PP_SCELTA_OPZIONE_FOOT_WAIT']	= 'we are working on your puzzle, wait please. It may take several seconds depending on the weight of the picture ...';
	$lang['PPZL_BOX'] = 'Box';
	$lang['PPZL_ALTRE_OPZIONI'] = 'Option';
?>