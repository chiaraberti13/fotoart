<?php
	...
	# 4.0.1
	$mgrlang['galleries_f_sort_d']			= "Alapértelmezett válogatás ebben a galériában.";
	$mgrlang['recommended']					= "Ajánlott";
	...
	# LOGIN AREA
	$mgrlang['login_title'] 				= "Bejelentkezés";
	$mgrlang['login_box_header']			= "Adminisztrációs felület";
	$mgrlang['login_username']				= "Felhasználónév";
	$mgrlang['login_password']				= "Jelszó";
	...
	$mgrlang['login_back'] 					= "Vissza a belépési oldalra";
	$mgrlang['login_mes_05']				= "Sikertelen bejelentkezés. Kérjük, próbálja újra.";
	$mgrlang['login_mes_06']				= "Ön kijelentkezett.";
	$mgrlang['login_mes_07']				= "Be kell jelentkezned, hogy az oldal megtekinthesd.";
	$mgrlang['login_mes_08']				= "Az időkorlátja lejárt.";
	$mgrlang['login_mes_09']				= "Kérjük Jelentkezzen be";
	$mgrlang['login_remember']				= "Emlékezz rám";
	$mgrlang['login_recover']				= "Bejelentkezési adatok visszaszerzése";
	$mgrlang['login_enter']					= "Belépés";
	$mgrlang['login_send']					= "Elküld";
	$mgrlang['login_check']					= "Felhasznélünév/jelszó ellenőrzése...";
	$mgrlang['login_loggedin']				= "Belépve";
	$mgrlang['login_loggedout']				= "Kilépve";
	$mgrlang['login_tab1']					= "Belépés";
	$mgrlang['login_tab2']					= "Új jelszó";
	$mgrlang['login_echeck']				= "E-mail cím ellenőrzése...";
	...
	# WELCOME PAGE
	$mgrlang['welcome_wel']					= "Üdvözlünk";
	$mgrlang['welcome_last_logged']			= "Az utolsó belépése";
	$mgrlang['welcome_page_title']			= "Irányítópult";
	$mgrlang['welcome_ftv_wizard']			= "Úgy tűnik, ez az első alkalom, hogy bejelentkezik az admin felületre. Szeretné, elindítani a beállítás varázslót?";
	$mgrlang['welcome_launch_wiz']			= "Szeretné elindítani a beállítás varázslót?";
	...
	$mgrlang['agree_general']				= "General Agreements";
	$mgrlang['agree_custom']				= "Your Agreements";
	...
	$mgrlang['setup_f_captcha']				= "Signup Form Captcha";
	...
	# NAVIGATION
	$mgrlang['nav_home']					= "Irányítópult";
	
	$mgrlang['nav_content']					= "Tartalomszerkesztő";
	...
	$mgrlang['subnav_agreements']			= "Agreements";
	...
	$mgrlang['nav_library']					= "Könyvtár";
	$mgrlang['nav_library_d']				= "Kérjük, válasszon az alábbi lehetőségek közül.";
	$mgrlang['subnav_galleries']			= "Galériák/Események";
	$mgrlang['subnav_galleries_d']			= "Nyilvános és magán galériák, események látrehozása, szerkesztáse.";
	$mgrlang['subnav_media']				= "Média";
	$mgrlang['subnav_media_d']				= "Az oldalon található médiák kezelése.";
	$mgrlang['subnav_asset_groups']			= "Média Csoportok";
	$mgrlang['subnav_asset_groups_d']		= "A média csoportok, a médiák admin felületen való könnyebb kezelése miatt vannak";
	$mgrlang['subnav_collections']			= "Digitális gyűjtemények";
	$mgrlang['subnav_collections_d']		= "Gyüjtemények létrehozása és kezelése.";
	$mgrlang['subnav_collections_groups']	= "Gyüjtemény csoportok";
	$mgrlang['subnav_collections_groups_d']	= "Gyüjtemény csoportok kezelése.";
	$mgrlang['subnav_digital_sp']			= "Digitális Profilok";
	$mgrlang['subnav_digital_sp_d']			= "A médiák digitális profiljainak a létrehozása";
	$mgrlang['subnav_prints']				= "Nyomtatványok";
	$mgrlang['subnav_prints_d']				= "Meglévő nyomtatvány elemek létrehozása és szerkesztése.";
	$mgrlang['subnav_packages']				= "Csomagok";
	$mgrlang['subnav_packages_d']			= "Nyomtatvány, digitális termékcsomagok látrehozása és szerkesztése.";
	$mgrlang['subnav_package_groups']		= "Csomag csoportok";
	$mgrlang['subnav_package_groups_d']		= "A Csomag csoportok, a csomagok admin felületen való könnyebb kezelése miatt vannak";
	$mgrlang['subnav_products']				= "Termékek";
	$mgrlang['subnav_products_d']			= "A webhelyen felsorolt ​​termékek, létrehozása és szerkesztése.";
	$mgrlang['subnav_product_groups']		= "Termék csoportok";
	$mgrlang['subnav_product_groups_d']		= "A Termék csoportok, a termékek admin felületen való könnyebb kezelése miatt vannak.";
	$mgrlang['subnav_add_media']			= "Új média hozzáadása";
	$mgrlang['subnav_add_files_d']			= "Új média feltöltése, importálása az oldalra.";	
	$mgrlang['subnav_media_types']			= "Média típusok";
	$mgrlang['subnav_media_types_d']		= "Méfia tipusok neveinek létrehozása, szerkesztése.";
	$mgrlang['subnav_media_types_groups']	= "Média típus csoportok";
	$mgrlang['subnav_media_types_groups_d']	= "A Média tipus csoportok a média tipusok kezelése miatt van.";
	$mgrlang['subnav_folders']				= "Mappák";
	$mgrlang['subnav_folders_d']			= "Mappák(ahol a médiák tárolva vannak) létrhozása és szerkesztése";
	$mgrlang['subnav_digital_sp_groups']	= "Digitális Profil csoportok";
	$mgrlang['subnav_digital_sp_groups_d']	= "A Digitális Profil csoportok, a Digitális Profilok admin felületen való könnyebb kezelése miatt vannak.";
	$mgrlang['subnav_print_groups']			= "Nyomtatvány csoportok";
	$mgrlang['subnav_print_groups_d']		= "A Nyomtatvány csoportok, a Nyomtatványok admin felületen való könnyebb kezelése miatt vannak.";
	$mgrlang['subnav_media_queue']			= "Média várólista";
	$mgrlang['subnav_media_queue_d']		= "Fotósok által feltöltött, jóváhagyásra váró médiák.";
	$mgrlang['subnav_media_comments']		= "Média Hozzászólások";
	$mgrlang['subnav_media_comments_d']		= "A látogatók által leadott hozzászólások, az oldalon található médiákról";
	$mgrlang['subnav_media_ratings']		= "Média Értékelések";
	$mgrlang['subnav_media_ratings_d']		= "A látogatók, médiákra leadott értékeléseik.";
	$mgrlang['subnav_media_tags']			= "Média Cimkék";
	$mgrlang['subnav_media_tags_d']			= "A látogatók által javasolt média cimkék.";
	
	$mgrlang['nav_sales']					= "Eladások";
	$mgrlang['nav_sales_d']					= "Kérjük, válasszon az alábbi lehetőségek közül.";
	$mgrlang['subnav_orders']				= "Megrendelések";
	$mgrlang['subnav_orders_d']				= "befejezett és függőben levő rendelések megtekintése";
	$mgrlang['subnav_order_groups']			= "Rendelési csoportok";
	$mgrlang['subnav_order_groups_d']		= "A Rendelési csoportok, a rendelések admin felületen való könnyebb kezelése miatt vannak.";
	$mgrlang['subnav_pending_orders']		= "Függőben lévő rendelések";
	$mgrlang['subnav_pending_orders_d']		= "Függőben lévő rendelések megtekintése.";	
	$mgrlang['subnav_lightboxes']			= "Albumok";
	$mgrlang['subnav_lightboxes_d']			= "A tagok által összeállitott albumok megtekintése.";
	$mgrlang['subnav_lightboxes_groups']	= "Album csoportok";
	$mgrlang['subnav_lightboxes_groups_d']	= "Az Album csoportok, a Albumok admin felületen való könnyebb kezelése miatt vannak.";	
	
	$mgrlang['subnav_billings']				= "Számlázás";
	$mgrlang['subnav_billings_d']			= "Megtekintheti a folyamatban lévő és befejezett tagok számára kiállított számlákat.";	
	$mgrlang['subnav_quotes']				= "Ajánlatkérések";
	$mgrlang['subnav_quotes_d']				= "Árajánlat kérések megtekintése.";	
	
	$mgrlang['nav_users']					= "Felhasználók";
	...
	$mgrlang['nav_settings']				= "Beállítások";
	$mgrlang['nav_settings_d']				= "Kérjük, válasszon a alábbi lehetőségek közül.";	
	$mgrlang['subnav_payment_options']		= "Fizetési átjárók";
