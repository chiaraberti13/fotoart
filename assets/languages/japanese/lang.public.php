<?php
	...
	******************************************************************/
	...
	// Media Labels
	$lang['mediaLabelTitle']		= "タイトル";
	$lang['mediaLabelDesc']			= "Description";
	$lang['mediaLabelCopyright']	= "著作権";
	$lang['mediaLabelRestrictions']	= "Usage Restrictions";
	$lang['mediaLabelRelease']		= "モデルリリース";
	$lang['mediaLabelKeys']			= "キーワード";
	$lang['mediaLabelFilename']		= "ファイル名";
	$lang['mediaLabelID']			= "ID";
	$lang['mediaLabelDate']			= "追加";
	$lang['mediaLabelDateC']		= "新規作成";
	$lang['mediaLabelDownloads']	= "ダウンロード";
	$lang['mediaLabelViews']		= "ビュー";
	$lang['mediaLabelPurchases']	= "購入";
	$lang['mediaLabelColors']		= "カラー";
	$lang['mediaLabelPrice']		= "価格";
	$lang['mediaLabelCredits']		= "クレジット";
	$lang['mediaLabelOwner']		= "所有者";
	$lang['mediaLabelUnknown']		= "不明";
	$lang['mediaLabelResolution']	= "ピクセル";
	$lang['mediaLabelFilesize']		= "ファイルサイズ";
	$lang['mediaLabelRunningTime']	= "Running Time";
	$lang['mediaLabelFPS']			= "FPS";
	$lang['mediaLabelFormat']		= "フォーマット";
	
	// Search
	$lang['search']					= "検索";
	$lang['searchEnterKeyMessage']	= "検索するにはキーワードを入力してください";
	...
	$lang['searchKeywords']			= "キーワード";
	$lang['searchTitle']			= "タイトル";
