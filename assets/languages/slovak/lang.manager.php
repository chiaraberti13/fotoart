<?php
	...
	# 4.6.1
	$mgrlang['image_zoom_warning']				= "Funkcia zoom zabraňuje ukážkové fotky na stránke s podrobnosťami z mierky pre mobilné zariadenia.";
	
	# 4.6
	$mgrlang['webset_f_facebook_link']			= "Odkaz na Facebook";
	$mgrlang['webset_f_facebook_link_d']		= "Pridať odkaz na vaše Facebook stránky.";
	$mgrlang['webset_f_twitter_link']			= "Odkaz na  Twitter";
	$mgrlang['webset_f_twitter_link_d']			= "Pridať odkaz na vaše Twitter stránky.";
	$mgrlang['webset_social_set']				= "Sociálne siete";
	
	# 4.4.6
	$mgrlang['mem_del_bill']				= "Ste si istí, že chcete zmazať tento účet?";
	
	# 4.4.5
	$mgrlang['setup_f_pubuploader']			= "Predvolený verejný dávkový Uploader";
	$mgrlang['setup_f_pubuploader_d']		= "Predvolený dávkový Uplader pre správcu.";
	$mgrlang['setup_f_uploader_op4']		= "Plupload (HTML5, Flash, Gears, Silverlight, HTML4)";
	
	# 4.4.4
	$mgrlang['licenses_attach']				= "Pripojiť Licenciu";
	$mgrlang['licenses_attach_d'] 			= "Pripojiť licenciu vytvorených v obsahu editor -> licencie / miesto dohody tejto licencie.";
	$mgrlang['gen_code_link_d']				= "HTML kód pre vloženie do vašej šablóny pre odkaz na túto dohodu.";
	$mgrlang['gen_email_template']			= "Email šablóna";
	$mgrlang['util_f_sql'] 					= "SQL Príkaz";
	$mgrlang['util_f_sql_d'] 				= "Vložiť dotaz na spustenie. VAROVANIE! Nepoužívajte ju, ak viete, čo robíte!";
	$mgrlang['util_f_exec']					= "Vykonať";
	$mgrlang['util_mes_07']					= "Váš dotaz bol úspešne spustený.";
	$mgrlang['util_mes_08']					= "Váš dotaz sa nepodarilo spustiť.";
	
	# 4.4.3
	$mgrlang['media_f_pr']							= "Property Release";
	$mgrlang['media_f_pr_d']						= "Does this media have a property release form.";
	$mgrlang['landf_f_gallerySorting']				= "Triedenie Zoznam Galérie";
	...
	$mgrlang['landf_f_gallerySorting_ascending']	= "Vzostupne A-Z";
	$mgrlang['landf_f_gallerySorting_descending']	= "Klesajúci Z-A";
	$mgrlang['landf_f_gallerySortBy_name']			= "Názov Galérie";
	$mgrlang['landf_f_gallerySortBy_sortnumber']	= "Gallérie číselne triedenie";
	$mgrlang['landf_f_gallerySortBy_created']		= "Dátum vytvorenia";
	$mgrlang['landf_f_gallerySortBy_edited']		= "Dátum editácie";
	$mgrlang['landf_f_gallerySortBy_activedate']	= "Aktívny dátum";
	$mgrlang['landf_f_gallerySortBy_expiredate']	= "Dátum expirácie";
	$mgrlang['landf_f_gallerySortBy_eventdate']		= "Dátum udalosti";
	$mgrlang['landf_f_gallerySortBy_eventlocation']	= "Umiestnenie udalosti";
	$mgrlang['landf_f_gallerySortBy_eventcode']		= "Kód udalosti";
	...
	# 4.4.2
	$mgrlang['landf_f_tagCloudSort_keyword']= "Abecedno-číslicový";
	$mgrlang['landf_f_tagCloudSort_default']= "Popularita";
	...
	# 4.4.0
	$mgrlang['approve_media']				= "Schvaliť Media";
	...
	$mgrlang['order_item_file'] 			= "Súbor";
	$mgrlang['order_item_ofile'] 			= "Originálny súbor";
	$mgrlang['order_item_afile'] 			= "Pripojený súbor";
	$mgrlang['geo_location_area']			= "Geografické umiestnenie";
	$mgrlang['geo_on_off']					= "Geografické umiestnenie on/off";
	$mgrlang['geo_on_off_d']				= "Turn on or off the geo location feature.";
	$mgrlang['geo_width']					= "Mapa šírka";
	...
	# LOGIN AREA
	$mgrlang['login_title'] 				= "Prihlásenie";
	...
	$mgrlang['login_email_address']			= "Email Adresa";
	...
	$mgrlang['photographer_caps']			= "PHOTOGRAF";
	$mgrlang['email_caps']					= "EMAIL";
	$mgrlang['compname_caps']				= "COMPANY NAME";
	$mgrlang['website_caps']				= "WEBSTRÁNKA";
	...
	$mgrlang['webset_time_1d']				= "Po 1 Deň";
	$mgrlang['webset_time_3d']				= "Po 3 Deň";
	$mgrlang['webset_time_5d']				= "Po 5 Deň";
	$mgrlang['webset_time_1w']				= "Po 1 Týždeň";
	$mgrlang['webset_time_2w']				= "Po 2 Týždeň";
	$mgrlang['webset_time_1m']				= "Po 1 Mesiac";
	$mgrlang['webset_time_2m']				= "Po 2 Mesiacoch";
	$mgrlang['webset_time_3m']				= "Po 3 Mesiacoch";
	$mgrlang['webset_time_6m']				= "Po 6 Mesiacoch";
	$mgrlang['webset_time_1y']				= "Po 1 Roku";
	...
	$mgrlang['media_f_mr_d']				= "Does this media have a model release form.";
	...
	$mgrlang['landf_f_galdsort']			= "Default Gallery Media Sorting";
	$mgrlang['landf_f_galdsort_d']			= "Default sorting on media within newly created galleries.";	
	...
	$mgrlang['setup_f_uploader']			= "Management Area Batch Uploader";
	$mgrlang['setup_f_uploader_d']			= "Choose the batch uploader you would like to use when adding media to your site through the management area.";
	...
	# LANGUAGES
	$mgrlang['languages_tab1']				= "Verejný jazyk";
	$mgrlang['languages_tab2']				= "Manažérsky jazyk";
	$mgrlang['languages_f_uselang']			= "Jazyk";
	$mgrlang['languages_f_uselang_d']		= "Vyberte jazyk (y) dostupné pre verejnú časť stránky. Nastavenie predvoleného jazyka.";
	$mgrlang['languages_f_uselang_d2']		= "Vyberte si jazyk pre manažérskú časť";
	$mgrlang['languages_defaults']			= "Zmena predvoleného dátumu a času pre tento jazyk";
	$mgrlang['languages_default']			= "Predvolený";
	$mgrlang['languages_lang']				= "Aktívny";
