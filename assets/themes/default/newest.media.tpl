	...
	<div id="container">
		...
		<div class="contentContainer">
			<div class="content" style="padding-left: 0; padding-right: 0;">
				<h1>{$lang.newestMedia}{if $config.settings.rss_newest} <a href="{linkto page='rss.php?mode=newestMedia'}"><img src="{$imgPath}/rss.icon.small.png" class="rssH1Icon rssPageH1Icon"></a>{/if}</h1>
				{if $mediaRows}
