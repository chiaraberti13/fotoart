...
{*inserito per spostare in header la lingua*}	
...
{*fine inserito per spostare in header la lingua*}
                    <li id="navGalleries"><a href="{linkto page="photo.puzzle.php"}"><img src="{$imgPath}/upload25.png" alt="{$lang.cart}">{$lang.mediaNavCarica}</a></li>
				{*	<li id="navGalleries"><a href="{linkto page="gallery.php?mode=gallery"}"><b>{$siteStats.media}</b> {$lang.mediaNav}{$lang.puzzleingalleries}</a></li>		   *} 			
	...
	{*<div><H1 style="text-color: white !important;"><center>Gentile utente, il sito è attualmente sotto aggiornamento e sarà completamente fruibile fra pochi giorni, la preghiamo di riprovare. Grazie</center></H1></div>*}
	</nav>