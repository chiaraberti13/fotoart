			...
			<div id="contentLeftContainer" class="searchOptionsLeftContainer">
				<div>
					...
					{if !$searchForm.inSearch or $mediaRows}
						...
						{if $searchForm.inSearch}<h1 style="margin-bottom: 15px;">{$lang.searchNarrow}</h1>{/if}
						
						<div>
							<h2>{$lang.searchHeaderKeywords}</h2>
							<div style="position: relative">
								<input type="text" name="searchPhrase" id="searchPhrase2" value="{*$lang.enterKeywords*}" class="searchInputBox" style="width: 196px;">									
							...
							<br><br>						
							<input type="button" value="{$lang.searchUpper}" style="width: 100%;" class="colorButton" id="searchButton">							
							<br><br>
