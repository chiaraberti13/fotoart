		...
		{		
			...
			case "del":
				if(!empty($_REQUEST['items']))
				{
					...
					# UPDATE ACTIVITY LOG
					save_activity($_SESSION['admin_user']['admin_id'],$mgrlang['subnav_agreements'],1,$mgrlang['gen_b_del'] . " > <strong>$log_titles</strong>");
		...
		Event.observe(window, 'load', function()
			...
			if($('abutton_add_new')!=null)
			{
				$('abutton_add_new').observe('click', function()
					{
						window.location.href='mgr.agreements.edit.php?edit=new';
					});
...
<body>
	...
	<div id="container">
        ...
        ?>
            ...
            <div id="actions_bar">	
            	<div class="sec_bar">
                    <img src="./images/mgr.badge.licenses.png" align="absmiddle" /><span><?php echo $mgrlang['subnav_agreements']; ?></span> &nbsp; 
                </div>                
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    ?>
                            ...
                            <tr class="<?php echo $row_class; ?>" onMouseOver="cellover(this,'#<?php echo $color_fade; ?>',32);" onMouseOut="cellout(this,'#<?php echo $color_fade; ?>');">
                                <td align="center" onclick="window.location.href='mgr.agreements.edit.php?edit=<?php echo $content->content_id; ?>'"><a name="row_<?php echo $content->content_id; ?>"></a><?php echo $content->content_id; ?></td>
                                <td align="left" onclick="window.location.href='mgr.agreements.edit.php?edit=<?php echo $content->content_id; ?>'"><a href="mgr.agreements.edit.php?edit=<?php echo $content->content_id; ?>" class="editlink"><?php echo $content->name; ?></a></td>
                                <td align="center" valign="middle" nowrap>
                                    <a href="mgr.agreements.edit.php?edit=<?php echo $content->content_id; ?>" class='actionlink'><img src="images/mgr.icon.edit.png" align="absmiddle" alt="<?php echo $mgrlang['gen_edit']; ?>" border="0" /><?php echo $mgrlang['gen_short_edit']; ?></a>
									<?php
										if($content->locked)
										{
											echo "&nbsp;";
