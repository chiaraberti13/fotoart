		...
		{		
			...
			case "del":
				if(!empty($_REQUEST['items']))
				{
					...
					# UPDATE ACTIVITY LOG
					save_activity($_SESSION['admin_user']['admin_id'],$mgrlang['subnav_email_content'],1,$mgrlang['gen_b_del'] . " > <strong>$log_titles</strong>");
		...
		Event.observe(window, 'load', function()
			...
			if($('abutton_add_new')!=null)
			{
				$('abutton_add_new').observe('click', function()
					{
						window.location.href='mgr.email.content.edit.php?edit=new';
					});
...
<body>
	...
	<div id="container">
        ...
        ?>
            ...
            <div id="actions_bar">	
            	<div class="sec_bar">
                    <img src="./images/mgr.badge.email.png" align="absmiddle" /><span><?php echo $mgrlang['subnav_email_content']; ?></span> &nbsp; 
                </div>                
            ...
            <div id="content">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <?php                        
                        ...
                        {
							$row_color = 0;
							echo "<tr><td colspan='4' style='background-color: #CCC; padding: 10px; color: #333; font-weight: bold; font-size: 12px; text-align: center;'>".$mgrlang[$ca->langid]."</td></tr>";
                    ...
                    ?>
                            ...
                            <tr class="<?php echo $row_class; ?>" onMouseOver="cellover(this,'#<?php echo $color_fade; ?>',32);" onMouseOut="cellout(this,'#<?php echo $color_fade; ?>');">
                                <td align="center" onclick="window.location.href='mgr.email.content.edit.php?edit=<?php echo $content->content_id; ?>'"><a name="row_<?php echo $content->content_id; ?>"></a><?php echo $content->content_id; ?></td>
                                <td align="left" onclick="window.location.href='mgr.email.content.edit.php?edit=<?php echo $content->content_id; ?>'"><a href="mgr.email.content.edit.php?edit=<?php echo $content->content_id; ?>" class="editlink"><?php echo $content->name; ?></a></td>
                                <td align="center" valign="middle" nowrap>
                                    <a href="mgr.email.content.edit.php?edit=<?php echo $content->content_id; ?>" class='actionlink'><img src="images/mgr.icon.edit.png" align="absmiddle" alt="<?php echo $mgrlang['gen_edit']; ?>" border="0" /><?php echo $mgrlang['gen_short_edit']; ?></a>
									<?php
										if($content->locked)
										{
											echo "&nbsp;";
