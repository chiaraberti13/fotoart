...
<head>
	...
	<title><?php echo $config['settings']['site_title'] . " Management Area"; ?></title>
...
<body>
	...
	<div id="container">
        ...
        <div id="content_container" style="background-color: #EEE">
            ...
            <!-- TITLE BAR AREA -->
            <div id="title_bar">
                <p><strong><?php echo $mgrlang['nav_settings']; ?></strong><br /><span><?php echo $mgrlang['nav_settings_d']; ?></span></p>
            </div>
