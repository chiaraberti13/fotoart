...
<head>
	...
	<title><?php echo $manager_page_title . " : " . $mgrlang['subnav_users']; ?></title>
...
<body>
	...
	<div id="container">
        ...
        <div id="content_container" style="background-color: #EEE">
            ...
            <!-- TITLE BAR AREA -->
            <div id="title_bar">
                <p><strong><?php echo $mgrlang['nav_users']; ?></strong><br /><span><?php echo $mgrlang['nav_users_d']; ?></span></p>
            </div>
            <!-- START CONTENT -->
