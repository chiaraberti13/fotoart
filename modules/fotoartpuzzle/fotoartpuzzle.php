...
class FotoArtPuzzle extends Module
{
            ...
            'form' => [
                ...
                'input' => [
                    [
                        ...
                        'desc' => $this->l('Comma separated list of product IDs that expose the wizard.'),
                    ],
                ],
                'submit' => ['title' => $this->l('Save')],
            ],
    ...
    protected function getConfigFormValues()
    {
        return [
            ...
            FAPConfiguration::ENABLED_PRODUCTS => FAPConfiguration::getEnabledProductsString(),
        ];
    }
    ...
    private function renderProductWizard($params)
    {
        ...
        $frontConfig = FAPConfiguration::getFrontConfig();
        $this->context->smarty->assign([
            ...
            'config' => json_encode($frontConfig),
