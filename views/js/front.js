...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFileUpload(file) {
        ...
        formData.append('token', (typeof artPuzzleToken !== 'undefined' ? artPuzzleToken : ''));
        
        // Invia richiesta
        fetch((typeof artPuzzleAjaxUrl !== 'undefined' ? artPuzzleAjaxUrl : '/module/art_puzzle/ajax'), {
            method: 'POST',
            body: formData
        })
    ...
    function loadPuzzleFormats() {
        ...
        params.append('token', (typeof artPuzzleToken !== 'undefined' ? artPuzzleToken : ''));
        
        // Invia richiesta
        fetch((typeof artPuzzleAjaxUrl !== 'undefined' ? artPuzzleAjaxUrl : '/module/art_puzzle/ajax') + '?' + params.toString())
        .then(response => response.json())
        .then(data => {
            if (loadingOverlay) {
                loadingOverlay.style.display = 'none';
